...
export async function POST(req: NextRequest) {
    ...
    if (event.type === 'charge.succeeded') {
        ...
        await updateOrderToPaid({ orderId: object.metadata.orderId, paymentResult: { id: object.id, status: 'COMPLETED', email_address: object.receipt_email || object.billing_details.email!, pricePaid: (object.amount / 100).toFixed() }})
